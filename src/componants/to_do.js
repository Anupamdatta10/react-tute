        ...
        <div className="container">
          ...
          {this.state.loading ? (
            ...
            this.state.task.map((task_details) => (
              <div
                className=" p-3 border border-primary  my-2 rounded-3 shadow row"
                key={task_details.T_id}
              >
                ...
                <div className="col-4 btn-toolbar">
                  <button
                    ...
                    onClick={() => this.updateTask(task_details)}
                  >
                    UPDATE
                  </button>
                  <button
                    ...
                    onClick={() => this.deleteTask(task_details)}
                  >
                    DELETE
                  </button>
                </div>
